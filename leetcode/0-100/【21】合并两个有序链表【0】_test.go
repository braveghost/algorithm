...
func TestMergeTwoLists_Iteration_2(t *testing.T) {
	type args struct {
		l1 *ListNode
		l2 *ListNode
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := MergeTwoLists_Iteration_2(tt.args.l1, tt.args.l2)
			fmt.Println(got)
			fmt.Println(got.Next)
			fmt.Println(got.Next.Next)
			fmt.Println(got.Next.Next.Next)
...
func TestMergeTwoLists_Recursive(t *testing.T) {
	type args struct {
		l1 *ListNode
		l2 *ListNode
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := MergeTwoLists_Recursive(tt.args.l1, tt.args.l2)
			fmt.Println(got)
			fmt.Println(got.Next)
			fmt.Println(got.Next.Next)
			fmt.Println(got.Next.Next.Next)
